...
export const apiRoutes: ApiRoute[] = [
  ...
  { router: 'inside_sales', prefix: '/api/inside-sales', keyEndpoints: 'GET /agents, GET /calls, GET /leads/{prospect_id}, GET /leads, GET /leads/{prospect_id}/detail', description: 'Routes for Inside Sales call data' },
