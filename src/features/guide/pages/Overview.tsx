...
import { Card, MermaidDiagram, Badge, PageHeader } from "@/features/guide/components";
...
export default function Overview() {
  ...
  return (
    ...
    >
      <PageHeader
        title="AI Evals Platform"
        subtitle="An interactive guide to the platform's architecture, evaluation workflows, and configuration across Voice RX and Kaira Bot workspaces."
        pageTitle="Overview"
      ...
      {/* Two Workspaces */}
      <h2
        className="text-2xl font-bold mt-6 mb-5"
        style={{ color: "var(--text)" }}
      >
        Two Workspaces
      </h2>
