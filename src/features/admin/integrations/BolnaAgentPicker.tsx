...
interface Props {
  /** Connection UUID this dispatch node points at. The picker is disabled until selected. */
  connectionId?: string;
  value: string;
  onChange(next: string): void;
}

/** Bolna agent picker backed by TanStack Query.
 *  Reopening within 30 s reuses cached data. Refresh button bypasses both FE and BE caches. */
